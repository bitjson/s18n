...
exports.filterElementsByTagNames = function(dom, tagsArray) {
...
exports.filterElementsByAttributes = function(dom, attributesArray) {
...
exports.extractStringsFromAttributes = function(dom, attributesArray) {
  var strings = [];
...
exports.hash = function(str, algorithm, length) {
